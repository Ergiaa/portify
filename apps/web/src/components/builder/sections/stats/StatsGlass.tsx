  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        top: -80, left: -60, filter: "blur(40px)",
      }} />
      <div style={{
        position: "absolute", width: 280, height: 280, borderRadius: "50%",
        background: "radial-gradient(circle,#ffce5b 0%, transparent 70%)",
        bottom: -80, right: -40, filter: "blur(40px)",
      }} />
        ...
        {config.stats.map((s, i) => {
          ...
          return (
            <div key={i} style={{
              ...
              border: "1px solid rgba(255,255,255,0.7)", borderRadius: 24, padding: 22,
              boxShadow: "0 16px 40px -16px rgba(80,40,140,0.18)",
              textAlign: "center",
            }}>
              <div style={{
              ...
              <div style={{ fontSize: 42, fontWeight: 800, letterSpacing: "-0.03em", color: "#241a3a", lineHeight: 1 }}>
                <Counter to={to} suffix={suffix} />
              </div>
              <div style={{ fontSize: 12, color: "#6b5495", marginTop: 6, fontWeight: 500 }}>{s.label}</div>
            </div>
          );
        })}
      </div>
